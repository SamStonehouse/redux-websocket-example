...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxDevtoolsLibReact = __webpack_require__(172);
	...
	var _componentsChatJs = __webpack_require__(320);

	var _componentsChatJs2 = _interopRequireDefault(_componentsChatJs);

	var _utilsChatWebsocketJs = __webpack_require__(337);

	var _utilsChatWebsocketJs2 = _interopRequireDefault(_utilsChatWebsocketJs);

	var _actionsChatActionsCreatorsJs = __webpack_require__(333);

	var ChatActions = _interopRequireWildcard(_actionsChatActionsCreatorsJs);

	var _constantsActionTypesJs = __webpack_require__(314);

	var ActionTypes = _interopRequireWildcard(_constantsActionTypesJs);

	var reducer = (0, _redux.combineReducers)(reducers);
	var finalCreateStore = (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2['default']), (0, _reduxDevtools.devTools)(), (0, _reduxDevtools.persistState)(window.location.href.match(/[?&]debug_session=([^&]+)\b/)), _redux.createStore);
	...
	_react2['default'].render(_react2['default'].createElement(
	  ...
	  _react2['default'].createElement(
	    ...
	    { store: store },
	    function () {
	      return _react2['default'].createElement(_componentsChatJs2['default'], null);
	    }
	  ),
	  _react2['default'].createElement(
	...
	var URL = 'chat.dev.yummypets.typhon.net';

	var sock = {
	  ws: null,
	  wsDipatcher: function wsDipatcher(msg) {
	  ...
	  wsListener: function wsListener() {
	    var _store$getState2 = store.getState();

	    var session = _store$getState2.session;
	    var lastAction = _store$getState2.lastAction;
	  ...
	  startWS: function startWS(session) {
	    if (!!sock.ws) {
	      sock.ws.close();
	    }

	    if (session.token) {
	      sock.ws = new _utilsChatWebsocketJs2['default'](URL, session.token, sock.wsDipatcher);
	    }
	  }
	};

	store.subscribe(function () {
	  return sock.wsListener();
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function combineReducers(reducers) {
	  ...
	  return function combination(state, action) {
	    ...
	    // React Native
	    "boolean" !== 'undefined' && (true) //eslint-disable-line no-undef
	    ) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _devTools = __webpack_require__(170);

	exports.devTools = _interopRequire(_devTools);

	var _persistState = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createDevTools = __webpack_require__(173);
	...
	var _LogMonitor = __webpack_require__(182);

	exports.LogMonitor = _interopRequire(_LogMonitor);

	var _DebugPanel = __webpack_require__(245);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactReduxLibComponentsCreateAll = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LogMonitorEntry = __webpack_require__(183);

	var _LogMonitorEntry2 = _interopRequireDefault(_LogMonitorEntry);

	var _LogMonitorButton = __webpack_require__(204);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _JSONTree = __webpack_require__(184);

	var _JSONTree2 = _interopRequireDefault(_JSONTree);

	var _LogMonitorEntryAction = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objType = __webpack_require__(185);

	var _objType2 = _interopRequireDefault(_objType);

	var _JSONObjectNode = __webpack_require__(186);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _JSONArrow = __webpack_require__(194);

	var _JSONArrow2 = _interopRequireDefault(_JSONArrow);

	var _grabNode = __webpack_require__(195);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _squashClickEvent = __webpack_require__(191);

	exports.SquashClickEventMixin = _interopRequire(_squashClickEvent);

	var _expandedStateHandler = __webpack_require__(192);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsDeepEqual = __webpack_require__(193);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsHexToRgb = __webpack_require__(199);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsBrighten = __webpack_require__(205);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _threezerotwofour = __webpack_require__(207);

	exports.threezerotwofour = _interopRequire(_threezerotwofour);

	var _apathy = __webpack_require__(208);

	exports.apathy = _interopRequire(_apathy);

	var _ashes = __webpack_require__(209);

	exports.ashes = _interopRequire(_ashes);

	var _atelierDune = __webpack_require__(210);

	exports.atelierDune = _interopRequire(_atelierDune);

	var _atelierForest = __webpack_require__(211);

	exports.atelierForest = _interopRequire(_atelierForest);

	var _atelierHeath = __webpack_require__(212);

	exports.atelierHeath = _interopRequire(_atelierHeath);

	var _atelierLakeside = __webpack_require__(213);

	exports.atelierLakeside = _interopRequire(_atelierLakeside);

	var _atelierSeaside = __webpack_require__(214);

	exports.atelierSeaside = _interopRequire(_atelierSeaside);

	var _bespin = __webpack_require__(215);

	exports.bespin = _interopRequire(_bespin);

	var _brewer = __webpack_require__(216);

	exports.brewer = _interopRequire(_brewer);

	var _bright = __webpack_require__(217);
	...
	var _codeschool = __webpack_require__(219);
	...
	var _default = __webpack_require__(221);

	exports['default'] = _interopRequire(_default);

	var _eighties = __webpack_require__(222);

	exports.eighties = _interopRequire(_eighties);

	var _embers = __webpack_require__(223);

	exports.embers = _interopRequire(_embers);

	var _flat = __webpack_require__(224);

	exports.flat = _interopRequire(_flat);

	var _google = __webpack_require__(225);

	exports.google = _interopRequire(_google);

	var _grayscale = __webpack_require__(226);

	exports.grayscale = _interopRequire(_grayscale);

	var _greenscreen = __webpack_require__(227);

	exports.greenscreen = _interopRequire(_greenscreen);

	var _harmonic = __webpack_require__(228);

	exports.harmonic = _interopRequire(_harmonic);

	var _hopscotch = __webpack_require__(229);

	exports.hopscotch = _interopRequire(_hopscotch);

	var _isotope = __webpack_require__(230);

	exports.isotope = _interopRequire(_isotope);

	var _marrakesh = __webpack_require__(231);

	exports.marrakesh = _interopRequire(_marrakesh);

	var _mocha = __webpack_require__(232);

	exports.mocha = _interopRequire(_mocha);

	var _monokai = __webpack_require__(233);

	exports.monokai = _interopRequire(_monokai);

	var _ocean = __webpack_require__(234);

	exports.ocean = _interopRequire(_ocean);

	var _paraiso = __webpack_require__(235);

	exports.paraiso = _interopRequire(_paraiso);

	var _pop = __webpack_require__(236);

	exports.pop = _interopRequire(_pop);

	var _railscasts = __webpack_require__(237);

	exports.railscasts = _interopRequire(_railscasts);

	var _shapeshifter = __webpack_require__(238);

	exports.shapeshifter = _interopRequire(_shapeshifter);

	var _solarized = __webpack_require__(239);

	exports.solarized = _interopRequire(_solarized);

	var _summerfruit = __webpack_require__(240);

	exports.summerfruit = _interopRequire(_summerfruit);

	var _tomorrow = __webpack_require__(241);

	exports.tomorrow = _interopRequire(_tomorrow);

	var _tube = __webpack_require__(242);

	exports.tube = _interopRequire(_tube);

	var _twilight = __webpack_require__(243);

	exports.twilight = _interopRequire(_twilight);

	var _nicinabox = __webpack_require__(244);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsCreateAll = __webpack_require__(247);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createProvider = __webpack_require__(248);

	var _createProvider2 = _interopRequireDefault(_createProvider);

	var _createProvideDecorator = __webpack_require__(250);

	var _createProvideDecorator2 = _interopRequireDefault(_createProvideDecorator);

	var _createConnector = __webpack_require__(252);

	var _createConnector2 = _interopRequireDefault(_createConnector);

	var _createConnectDecorator = __webpack_require__(256);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCreateStoreShape = __webpack_require__(249);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsGetDisplayName = __webpack_require__(251);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsShallowEqual = __webpack_require__(253);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _messagesJs = __webpack_require__(260);

	var _messagesJs2 = _interopRequireDefault(_messagesJs);

	var _sessionJs = __webpack_require__(318);

	var _sessionJs2 = _interopRequireDefault(_sessionJs);

	var _friendlistJs = __webpack_require__(319);

	var _friendlistJs2 = _interopRequireDefault(_friendlistJs);
	...
	exports['default'] = { messages: _messagesJs2['default'], session: _sessionJs2['default'], friendlist: _friendlistJs2['default'], lastAction: lastAction };
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defineProperty = __webpack_require__(275)['default'];

	var _toConsumableArray = __webpack_require__(278)['default'];

	var _Object$keys = __webpack_require__(310)['default'];
	...
	var _utilsMessageJs = __webpack_require__(315);

	var _utilsMessageJs2 = _interopRequireDefault(_utilsMessageJs);
	  ...
	  switch (action.type) {
	    case _constantsActionTypes.RECEIVE_MESSAGE:
	      if (action.message.from === action.session.id) {
	        return {
	          conversations: _extends({}, state.conversations, _defineProperty({}, action.message.to, [].concat(_toConsumableArray(state.conversations[action.message.to]), [new _utilsMessageJs2['default'](action.message)])))
	        };
	      } else if (action.message.to === action.session.id) {
	        return {
	          conversations: _extends({}, state.conversations, _defineProperty({}, action.message.from, [].concat(_toConsumableArray(state.conversations[action.message.from]), [new _utilsMessageJs2['default'](action.message)])))
	        };
	      } else {
	        return state;
	      }

	    case _constantsActionTypes.FRIEND_CONNECT:
	      return {
	        conversations: _extends({}, state.conversations, _defineProperty({}, action.friend.id, []))
	      };

	    case _constantsActionTypes.SELECT_FRIEND:
	      var _res = {};
	      _res.conversations = _extends({}, state.conversations);
	      _Object$keys(state.conversations).map(function (key) {
	        if (parseInt(key) === action.friend.id) {
	          _res.conversations[key] = state.conversations[key].map(function (msg) {
	            return new _utilsMessageJs2['default'](msg, true);
	          });
	        } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def = __webpack_require__(265);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$defineProperty = __webpack_require__(276)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Array$from = __webpack_require__(279)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LIBRARY         = __webpack_require__(285)
	  , $def            = __webpack_require__(265)
	  , $redef          = __webpack_require__(286)
	  , hide            = __webpack_require__(287)
	  , has             = __webpack_require__(291)
	  , SYMBOL_ITERATOR = __webpack_require__(292)('iterator')
	...
	module.exports = function(Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCE){
	  __webpack_require__(296)(Constructor, NAME, next);
	  ...
	  // Fix native
	  if(_native){
	    var IteratorPrototype = __webpack_require__(274).getProto(_default.call(new Base));
	    // Set @@toStringTag to native iterators
	    __webpack_require__(297)(IteratorPrototype, TAG, true);
	    // FF fix
	  ...
	  if(DEFAULT){
	    ...
	    } else $def($def.P + $def.F * __webpack_require__(298), NAME, methods);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(289) ? function(object, key, value){
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(name){
	  return store[name] || (store[name] =
	    Symbol && Symbol[name] || (Symbol || __webpack_require__(294))('Symbol.' + name));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(287)(IteratorPrototype, __webpack_require__(292)('iterator'), function(){ return this; });

	module.exports = function(Constructor, NAME, next){
	  Constructor.prototype = $.create(IteratorPrototype, {next: __webpack_require__(288)(1,next)});
	  __webpack_require__(297)(Constructor, NAME + ' Iterator');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var has  = __webpack_require__(291)
	  , hide = __webpack_require__(287)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SYMBOL_ITERATOR = __webpack_require__(292)('iterator')
	  , SAFE_CLOSING    = false;
	try {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(267).Object.keys;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(KEY, exec){
	  var $def = __webpack_require__(265)
	    , fn   = (__webpack_require__(267).Object || {})[KEY] || Object[KEY]
	    , exp  = {};
	  exp[KEY] = exec(fn);
	  $def($def.S + $def.F * __webpack_require__(290)(function(){ fn(1); }), 'Object', exp);
	};
...
/***/ function(module, exports) {
	...
	var AUTH_CONNECTING = 'AUTH_CONNECTING';
	exports.AUTH_CONNECTING = AUTH_CONNECTING;
	var AUTH_CONNECTED = 'AUTH_CONNECTED';
	exports.AUTH_CONNECTED = AUTH_CONNECTED;
	var AUTH_ERROR = 'AUTH_ERROR';

	exports.AUTH_ERROR = AUTH_ERROR;
	var FRIEND_CONNECT = 'FRIEND_CONNECT';
	exports.FRIEND_CONNECT = FRIEND_CONNECT;
	var FRIEND_DISCONNECT = 'FRIEND_DISCONNECT';
	exports.FRIEND_DISCONNECT = FRIEND_DISCONNECT;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function session(state, action) {
	  ...
	  switch (action.type) {
	    case _constantsActionTypes.AUTH_CONNECTING:
	      return {
	        loading: true,
	        connected: false,
	        token: state.token,
	    ...
	    case _constantsActionTypes.AUTH_CONNECTED:
	      return {
	        loading: false,
	        connected: true,
	    ...
	    case _constantsActionTypes.AUTH_ERROR:
	      return {
	        loading: false,
	        connected: false,
	        token: null,
	  ...
	  switch (action.type) {
	    case _constantsActionTypes.FRIEND_CONNECT:
	      return _extends({}, state, {
	        friends: _extends({}, state.friends, _defineProperty({}, action.friend.id, action.friend))
	      });

	    case _constantsActionTypes.FRIEND_DISCONNECT:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _get = __webpack_require__(321)['default'];

	var _inherits = __webpack_require__(326)['default'];
	...
	var _chatloginJs = __webpack_require__(334);

	var _chatloginJs2 = _interopRequireDefault(_chatloginJs);

	var _chatfriendsJs = __webpack_require__(336);

	var _chatfriendsJs2 = _interopRequireDefault(_chatfriendsJs);
	...
	var ChatContainer = (function (_React$Component) {
	  ...
	  _createClass(ChatContainer, [{
	    ...
	    value: function renderChild(_ref) {
	      ...
	      return _react2['default'].createElement(Chat, { messages: messages, session: session, friendlist: friendlist, actions: actions });
	    }
	  }]);
	...
	var Chat = (function (_React$Component2) {
	  ...
	  _createClass(Chat, [{
	    key: 'handleSendPost',
	    value: function handleSendPost() {
	      var messageNode = _react2['default'].findDOMNode(this.refs.message);
	      var idNode = _react2['default'].findDOMNode(this.refs.id);

	      var fromID = this.props.session.user._session.default_pet_id;
	      // let toID = parseInt(idNode.value);
	      var toID = this.props.friendlist.selectedFriend;
	      var text = messageNode.value.trim();
	    ...
	    value: function renderMessages() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_chatloginJs2['default'], null),
	        _react2['default'].createElement(
	          'div',
	          { style: styles.msgInput },
	          _react2['default'].createElement('input', { style: styles.msgArea, type: 'text', ref: 'message', placeholder: 'message' }),
	          _react2['default'].createElement('button', { style: styles.msgBtn, type: 'button', onClick: function () {
	              return _this.handleSendPost();
	            } })
	        ),
	        _react2['default'].createElement(_chatfriendsJs2['default'], null),
	        _react2['default'].createElement(
	          'div',
	          ...
	          _react2['default'].createElement(
	            ...
	            this.props.messages.conversations[this.props.friendlist.selectedFriend].map(function (msg) {
	              return _react2['default'].createElement(
	                'li',
	                { style: _this.setMessageStyle(msg) },
	                msg.message
	              );
	            })
	          )
	    ...
	    key: 'renderMessagesEmpty',
	    value: function renderMessagesEmpty() {
	      var _this2 = this;
	    ...
	    value: function render() {
	      var _props = this.props;
	      var friendlist = _props.friendlist;
	    ...
	    key: 'setMessageStyle',
	    value: function setMessageStyle(msg) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(313)('getOwnPropertyDescriptor', function($getOwnPropertyDescriptor){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$create = __webpack_require__(327)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def = __webpack_require__(265);
	$def($def.S, 'Object', {setPrototypeOf: __webpack_require__(332).set});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} // eslint-disable-line
	    ? function(buggy, set){
	        try {
	          set = __webpack_require__(300)(Function.call, getDesc(Object.prototype, '__proto__').set, 2);
	          set({}, []);
	        } catch(e){ buggy = true; }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function receiveMessage(message) {
	  console.log(message);
	  return {
	    type: _constantsActionTypes.RECEIVE_MESSAGE,
	    message: message
	  };
	}

	function postMessage(text, fromID, toID) {
	  return {
	    type: _constantsActionTypes.POST_MESSAGE,
	    text: text,
	    fromID: fromID,
	    toID: toID
	  };
	...
	function receiveEvent(event, session) {
	  ...
	  switch (event.event_type) {
	    ...
	    case 2:
	      if (event.presence) {
	        return {
	          type: _constantsActionTypes.FRIEND_CONNECT,
	          friend: event
	        };
	      } else {
	        return {
	          type: _constantsActionTypes.FRIEND_DISCONNECT,
	          friend: event
	        };
	      }
	...
	function selectFriend(friend) {
	  return {
	    type: _constantsActionTypes.SELECT_FRIEND,
	    friend: friend
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsAuthActionsCreatorsJs = __webpack_require__(335);

	var AuthActions = _interopRequireWildcard(_actionsAuthActionsCreatorsJs);
	...
	var ChatLoginContainer = (function (_React$Component) {
	  _inherits(ChatLoginContainer, _React$Component);

	  function ChatLoginContainer() {
	    _classCallCheck(this, ChatLoginContainer);

	    _get(Object.getPrototypeOf(ChatLoginContainer.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(ChatLoginContainer, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        _reactRedux.Connector,
	    ...
	    value: function renderChild(_ref) {
	      ...
	      var actions = (0, _redux.bindActionCreators)(AuthActions, dispatch);
	      return _react2['default'].createElement(ChatLogin, { actions: actions, session: session });
	    }
	  }]);

	  return ChatLoginContainer;
	})(_react2['default'].Component);

	exports['default'] = ChatLoginContainer;

	var ChatLogin = (function (_React$Component2) {
	  _inherits(ChatLogin, _React$Component2);

	  function ChatLogin() {
	    _classCallCheck(this, ChatLogin);

	    _get(Object.getPrototypeOf(ChatLogin.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(ChatLogin, [{
	    key: 'handleLogin',
	    value: function handleLogin() {
	      var loginNode = _react2['default'].findDOMNode(this.refs.login);
	      var passNode = _react2['default'].findDOMNode(this.refs.pass);

	      var a = loginNode.value;
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        'div',
	        { style: this.props.session.token ? styles.container : styles.container },
	        _react2['default'].createElement('input', { style: styles.input, type: 'email', ref: 'login', placeholder: 'email' }),
	        _react2['default'].createElement('input', { style: styles.input, type: 'password', ref: 'pass', placeholder: 'password' }),
	        _react2['default'].createElement(
	          'button',
	          { style: styles.loginBtn, type: 'button', onClick: function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function connect(credentials) {
	  return function (dispatch) {
	    ...
	    fetch('http://api.dev.yummypets.typhon.net/connect', requestParams).then(function (res) {
	      return res.json();
	    }).then(function (res) {
	...
	function connectSuccess(user) {
	  return {
	    type: _constantsActionTypes.AUTH_CONNECTED,
	    user: user
	  };
	}

	function connectError(errorMessage) {
	  return {
	    type: _constantsActionTypes.AUTH_ERROR,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatFriendsContainer = (function (_React$Component) {
	  _inherits(ChatFriendsContainer, _React$Component);

	  function ChatFriendsContainer() {
	    _classCallCheck(this, ChatFriendsContainer);

	    _get(Object.getPrototypeOf(ChatFriendsContainer.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(ChatFriendsContainer, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        _reactRedux.Connector,
	    ...
	    value: function renderChild(_ref) {
	      ...
	      var actions = (0, _redux.bindActionCreators)(ChatActions, dispatch);
	      return _react2['default'].createElement(ChatFriends, { actions: actions, friendlist: friendlist, messages: messages });
	    }
	  }]);
	...
	exports['default'] = ChatFriendsContainer;

	function checkConversationChanged() {
	  var _this = this;

	  return _Object$keys(this.props.messages.conversations).map(function (key) {
	    return nextProps.messages.conversations[key] !== _this.props.messages.conversations[key];
	  }).some(function (bool) {
	    return !!bool;
	  });
	}

	var ChatFriends = (function (_React$Component2) {
	  _inherits(ChatFriends, _React$Component2);

	  function ChatFriends() {
	    _classCallCheck(this, ChatFriends);

	    _get(Object.getPrototypeOf(ChatFriends.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(ChatFriends, [{
	    ...
	    key: 'handleClick',
	    value: function handleClick(friend) {
	      this.props.actions.selectFriend(friend);
	    }
	  }, {
	    key: 'renderFriendListEmpty',
	    value: function renderFriendListEmpty() {
	      return _react2['default'].createElement(
	        'div',
	    ...
	    key: 'renderFriendList',
	    value: function renderFriendList() {
	      var _this2 = this;

	      var friends = this.props.friendlist.friends;
	      var selectedFriend = this.props.friendlist.selectedFriend;
	      var conversations = this.props.messages.conversations;
	      return _react2['default'].createElement(
	        'div',
	        { style: styles.friendListContainer },
	        _react2['default'].createElement(
	          ...
	          _Object$keys(friends).map(function (key) {
	            return _react2['default'].createElement(
	              'li',
	              {
	                onClick: function () {
	                  return _this2.handleClick(friends[key]);
	                },
	                style: _this2.computeListItemStyle(key, selectedFriend) },
	              friends[key].pseudo
	            );
	          })
	        )
	    ...
	    key: 'render',
	    value: function render() {
	      if (_Object$keys(this.props.friendlist.friends).length === 0) {
	    ...
	    key: 'computeListItemStyle',
	    value: function computeListItemStyle(key, selectedFriend) {
	      var friends = this.props.friendlist.friends;
	      var conversations = this.props.messages.conversations;
	      var hasNewMessages = conversations[key].some(function (msg) {
	        return !msg.read;
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatWS = (function () {
	  function ChatWS(url, token, dispatcher) {
	  ...
	  _createClass(ChatWS, [{
	    key: "postMessage",
	    value: function postMessage(text, fromID, toID) {
